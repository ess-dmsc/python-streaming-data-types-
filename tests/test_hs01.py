...
class TestSerialisationHs01:
    ...
    def test_serialises_and_deserialises_hs01_message_correctly_for_full_1d_data(self):
        """
        ...
        buf = serialise_hs01(original_hist)
        hist = deserialise_hs01(buf)
    ...
    def test_serialises_and_deserialises_hs01_message_correctly_for_minimal_1d_data(
        self,
    ):
        """
        Round-trip to check what we serialise is what we get back.
    ...
    def test_serialises_and_deserialises_hs01_message_correctly_for_full_2d_data(self):
        """
        Round-trip to check what we serialise is what we get back.
        """
        original_hist = {
    ...
    def test_if_buffer_has_wrong_id_then_throws(self):
        ...
        with pytest.raises(WrongSchemaException):
            deserialise_hs01(buf)

    def test_serialises_and_deserialises_hs01_message_correctly_for_int_array_data(
        self,
    ):
        """
        Round-trip to check what we serialise is what we get back.
    ...
    def test_serialise_and_deserialise_hs01_message_returns_int32_type(self):
    ...
    def test_serialise_and_deserialise_hs01_message_returns_int64_type(self):
    ...
    def test_serialise_and_deserialise_hs01_message_returns_float32_type(self):
    ...
    def test_serialise_and_deserialise_hs01_message_returns_float64_type(self):
    ...
    def test_serialises_and_deserialises_hs01_message_correctly_when_float_input_is_not_ndarray(
        self,
    ):
        """
        Round-trip to check what we serialise is what we get back.
    ...
    def test_serialises_and_deserialises_hs01_message_correctly_when_int_input_is_not_ndarray(
        self,
    ):
        """
        Round-trip to check what we serialise is what we get back.
