...
def ArrayUInt8Start(builder): builder.StartObject(1)
def Start(builder):
    return ArrayUInt8Start(builder)
def ArrayUInt8AddValue(builder, value): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(value), 0)
def AddValue(builder, value):
    return ArrayUInt8AddValue(builder, value)
def ArrayUInt8StartValueVector(builder, numElems): return builder.StartVector(1, numElems, 1)
def StartValueVector(builder, numElems):
    return ArrayUInt8StartValueVector(builder, numElems)
def ArrayUInt8End(builder): return builder.EndObject()
def End(builder):
