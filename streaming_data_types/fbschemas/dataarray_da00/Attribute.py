...
def AddDescription(builder, description):
    return AttributeAddDescription(builder, description)
...
def AddSource(builder, source):
    return AttributeAddSource(builder, source)
...
def AddDataType(builder, dataType):
    return AttributeAddDataType(builder, dataType)
...
def AddData(builder, data):
    return AttributeAddData(builder, data)
