...
def LogDataStart(builder): builder.StartObject(4)
def Start(builder):
...
def LogDataAddTimestamp(builder, timestamp): builder.PrependInt64Slot(1, timestamp, 0)
def AddTimestamp(builder, timestamp):
    return LogDataAddTimestamp(builder, timestamp)
def LogDataAddValueType(builder, valueType): builder.PrependUint8Slot(2, valueType, 0)
def AddValueType(builder, valueType):
    return LogDataAddValueType(builder, valueType)
def LogDataAddValue(builder, value): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(value), 0)
