...
class Event44Message(object):
    ...
    def Event44MessageBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x65\x76\x34\x34", size_prefixed=size_prefixed)
...
def Event44MessageStart(builder): builder.StartObject(6)
def Start(builder):
    return Event44MessageStart(builder)
def Event44MessageAddSourceName(builder, sourceName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(sourceName), 0)
def AddSourceName(builder, sourceName):
    return Event44MessageAddSourceName(builder, sourceName)
def Event44MessageAddMessageId(builder, messageId): builder.PrependInt64Slot(1, messageId, 0)
def AddMessageId(builder, messageId):
    return Event44MessageAddMessageId(builder, messageId)
def Event44MessageAddReferenceTime(builder, referenceTime): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(referenceTime), 0)
def AddReferenceTime(builder, referenceTime):
    return Event44MessageAddReferenceTime(builder, referenceTime)
def Event44MessageStartReferenceTimeVector(builder, numElems): return builder.StartVector(8, numElems, 8)
def StartReferenceTimeVector(builder, numElems):
    return Event44MessageStartReferenceTimeVector(builder, numElems)
def Event44MessageAddReferenceTimeIndex(builder, referenceTimeIndex): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(referenceTimeIndex), 0)
...
def Event44MessageStartReferenceTimeIndexVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartReferenceTimeIndexVector(builder, numElems):
    return Event44MessageStartReferenceTimeIndexVector(builder, numElems)
def Event44MessageAddTimeOfFlight(builder, timeOfFlight): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(timeOfFlight), 0)
def AddTimeOfFlight(builder, timeOfFlight):
    return Event44MessageAddTimeOfFlight(builder, timeOfFlight)
def Event44MessageStartTimeOfFlightVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartTimeOfFlightVector(builder, numElems):
    return Event44MessageStartTimeOfFlightVector(builder, numElems)
def Event44MessageAddPixelId(builder, pixelId): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(pixelId), 0)
def AddPixelId(builder, pixelId):
    return Event44MessageAddPixelId(builder, pixelId)
def Event44MessageStartPixelIdVector(builder, numElems): return builder.StartVector(4, numElems, 4)
